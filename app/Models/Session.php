...
{
    protected $allowIncluded = ['course.program','instructor','course.environment.headquarters','assistances.apprentice.user', 'instructor.user', 'course','course.program.subjects','rap', 'course.subject', 'rap.subject',  'instructor.knowledgeNetwork',];
